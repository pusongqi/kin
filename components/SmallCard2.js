import {
  ...
  export default function SmallCard2({
    textMessage,
    user,
    imageInput,
    showMediumTaskModal,
              ...
              <View style={styles.container}>
                <View style={styles.holdBigAvatar}>
                  <Image
                    ...
                    source={require("../assets/images/LargePinkHairAvatar.png")}
                  ></Image>
                </View>
                <View style={styles.modalView}>
                  ...
                  <View style={styles.answerContainer}>
                    ...
                    <Text style={styles.answerCardBody}> olive bar chicken. this is all you need: chicken, garlic, and tomato!</Text>
                  </View>
                  {mediumTaskLike ? (
                    <View style={styles.holdLikesList}>
                      <Image
                        style={styles.likesList}
                        source={require("../assets/images/LikeListYesUs2.png")}
                      ></Image>
                    </View>
                  ) : (
                    <View style={styles.holdNotLikesList}>
                      <Image
                        ...
                        source={require("../assets/images/LikeListNoUs2.png")}
                      ></Image>
                    </View>
                  )}
